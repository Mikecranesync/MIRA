...
from printsense.designations import decode, detect_profile, relate
...
def run_benchmark() -> dict:
    ...
    if digit_samples:
        ...
        # digit-first can be any profile
        profile_pass += 1
    ...
    for raw1, raw2 in non_alias_pairs:
        try:
            ...
            pass
    false_alias_rate = 1.0 - (
        false_alias_count / len(non_alias_pairs)
        if non_alias_pairs else 0.0
    )
