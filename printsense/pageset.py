...
def _xref_entries(raw: str, sig: str, source_field: str, prov: dict, confidence) -> list[dict]:
...
def load_pageset(
    manifest: dict, graphs: dict[str, dict], decoder_profile: str | None = None
) -> dict:
