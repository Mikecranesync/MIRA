...
_SRC_81346 = {
    "source_title": "Industrial systems - structuring principles "
    "and reference designations - Part 2: letter "
    "codes (derived)",
    "organization": "IEC/CENELEC",
    "document_id": "IEC 81346-2",
    "section": "class tables (derived summary)",
    "confidence": 0.7,
    "reviewed_date": "2026-07-15",
    "verification": "secondary_sources_only",
    "note": "derived candidate meanings; edition differences exist",
}
_SRC_DIN = {
    "source_title": "Legacy German drawing practice (derived)",
    "organization": "DIN",
    "document_id": "DIN 40719-2 (withdrawn)",
...
CLASS_CODES: dict[str, list[dict]] = {
    "K": [
        {"meaning": "relay / contactor (switching, control circuit)", **_SRC_DIN},
        {"meaning": "processing / signal switching object", **_SRC_81346},
    ],
    "Q": [
        {
            "meaning": "power circuit switching device (breaker, disconnector, motor contactor)",
            **_SRC_81346,
        }
    ],
    "F": [{"meaning": "protection device (fuse, overload, protective relay)", **_SRC_81346}],
    "M": [{"meaning": "motor / driving object", **_SRC_81346}],
    "S": [
        {"meaning": "control switch / pushbutton / selector", **_SRC_DIN},
        {"meaning": "signal-source or switching object (edition-dependent)", **_SRC_81346},
    ],
    "B": [{"meaning": "sensor / transducer (measurement conversion)", **_SRC_81346}],
    "X": [{"meaning": "terminal / connecting object", **_SRC_81346}],
    "XS": [{"meaning": "socket / connector (connecting object subtype)", **_SRC_DIN}],
    ...
    "U": [
        {
            "meaning": "keeping objects in a defined position (current-edition candidate)",
            **_SRC_81346,
        },
        {
            "meaning": "converter / drive (field convention - UNVERIFIED against any edition text)",
            **{
                **_SRC_DIN,
                "confidence": 0.15,
    ...
    "A": [{"meaning": "assembly / subassembly (composite object)", **_SRC_81346}],
    "H": [{"meaning": "signalling / indicating device (lamp, horn)", **_SRC_DIN}],
    "P": [{"meaning": "measuring / indicating instrument", **_SRC_81346}],
    "E": [{"meaning": "miscellaneous (lighting, heating) - edition-dependent", **_SRC_DIN}],
}
