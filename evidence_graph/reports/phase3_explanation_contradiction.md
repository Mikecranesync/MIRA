# Ask MIRA — Line is line blocked. Most likely cause: Photoeye blocked / fouled on Conveyor01 — medium confidence (confidence reduced by contradicting evidence) (ranked hypothesis).
...
**Confidence: Medium** _(reduced by contradicting evidence)_
...
- _Evidence AGAINST:_
    - [Tag] synthetic_beverage_co.demo_site.bottling.bottlingline1.conveyor01.production.counts_outfeed_value_value = still increasing (~120/min)
...
## 2. Also possible: Motor overload / thermal trip
**Confidence: Medium**
...
## 3. Also possible: Conveyor mechanical jam
**Confidence: Low** _(reduced by contradicting evidence)_
