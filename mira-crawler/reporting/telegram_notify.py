...
AGENTS: dict[str, dict[str, str]] = {
    "morning_brief":    {"name": "Deb Castillo (Morning Brief)", "emoji": "☀️"},
    "safety_alert":     {"name": "Linda Torres (Safety)",        "emoji": "🛑"},
    "safety_scan":      {"name": "Linda Torres (Safety)",        "emoji": "🛑"},
    "pm_escalation":    {"name": "PM Scheduler",                 "emoji": "🔧"},
    "kb_growth":        {"name": "Rico Mendez (KB Growth)",      "emoji": "📚"},
    "social_publisher": {"name": "Content Team",                 "emoji": "📱"},
    "content_draft":    {"name": "Content Team",                 "emoji": "📱"},
    "benchmark":        {"name": "Elena Park (QA)",              "emoji": "📊"},
    "qa_benchmark":     {"name": "Elena Park (QA)",              "emoji": "📊"},
    "lead_hunter":      {"name": "Sales Scout",                  "emoji": "🎯"},
    "lead_scout":       {"name": "Sales Scout",                  "emoji": "🎯"},
    "churn_monitor":    {"name": "Customer Success",             "emoji": "⚠️"},
    "billing_health":   {"name": "Marcus Johnson (Billing)",     "emoji": "💰"},
    "asset_intel":      {"name": "Asset Intelligence",           "emoji": "🧠"},
    "cmms_sync":        {"name": "CMMS Sync",                    "emoji": "🔄"},
    "training_loop":    {"name": "Training Engineer",            "emoji": "🎓"},
    "corpus_refresh":   {"name": "Research",                     "emoji": "🔬"},
    "inbox_manager":    {"name": "Alex Rivera (Inbox)",          "emoji": "📧"},
    "inbox_triage":     {"name": "Alex Rivera (Inbox)",          "emoji": "📧"},
    "system":           {"name": "System",                       "emoji": "⚙️"},
    "daily_digest":     {"name": "System",                       "emoji": "⚙️"},
}
