...
## Summary
- entities: 1 enterprise / 1 site / 2 area / 2 line / 2 (proposed) cell / 4 asset
- signals: 35 (live + metadata) ; relationships: 11
- suggestions: 58 total, 0 auto-approved (must be 0), 4 need review
...
| asset | `synthetic_beverage_co.demo_site.bottling.bottlingline1.conveyor01` | Conveyor01 | high | suggested |
...
### live_bool (10)
- `synthetic_beverage_co.demo_site.bottling.bottlingline1.conveyor01.status.productionrun_running`  (medium, suggested)  unit=-
- `synthetic_beverage_co.demo_site.bottling.bottlingline1.conveyor01.status.blocked_value_value`  (medium, suggested)  unit=-
- `synthetic_beverage_co.demo_site.bottling.bottlingline1.conveyor01.status.starved_value_value`  (medium, suggested)  unit=-
- `synthetic_beverage_co.demo_site.bottling.bottlingline1.conveyor01.status.photoeye_blocked_value_value`  (medium, suggested)  unit=-
...
### live_counter (4)
- `synthetic_beverage_co.demo_site.bottling.bottlingline1.conveyor01.production.counts_outfeed_value_value`  (medium, suggested)  unit=Units
...
### live_state (5)
- `synthetic_beverage_co.demo_site.bottling.bottlingline1.conveyor01.status.state_name`  (medium, suggested)  unit=-
...
### live_analog (6)
- `synthetic_beverage_co.demo_site.bottling.bottlingline1.conveyor01.process.drive_motorcurrent`  (medium, suggested)  unit=mA
...
- static_metadata signals (excluded from UNS draft): 10
- unknown signals (needs_review): 0

## Relationships
- `contains` (structural, high): 9
- `feeds` (inferred upstream->downstream, low/needs_review): 2
  - `synthetic_beverage_co.demo_site.bottling.bottlingline1.conveyor01` -> `synthetic_beverage_co.demo_site.bottling.bottlingline1.caploader01`  (low, needs_review)
...
- [low] Inferred material flow 'synthetic_beverage_co.demo_site.bottling.bottlingline1.conveyor01' -> 'synthetic_beverage_co.demo_site.bottling.bottlingline1.caploader01' from asset order within the line (export order; physical flow NOT confirmed by evidence).
