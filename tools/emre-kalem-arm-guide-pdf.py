...
"""
    ...
    story.append(
        table(
            ...
            [
                [
                    "Red",
                    "External switched +5V servo bus",
                    "Never to an Uno digital pin. Avoid Uno 5V for servo motor power.",
                ],
                [
                    "Brown or black",
                    "Servo ground bus and Arduino GND",
                    "This is the shared reference for the signal pulse.",
                ],
                [
                    "Orange, yellow, or white",
                    "Uno signal pin D3/D4/D5/D6/D9/D10/D11",
                    "Signal only; current is tiny compared with motor current.",
                ],
            ],
            [1.25, 2.2, 3.2],
        )
        ...
        table(
            ...
            [
                [
                    ...
                    "D3",
                    "Red to switched 5V",
                    "Brown/black to ground bus",
                    "Matches Emre original sketch; verify the base cannot hit wiring.",
                ],
                [
                    "arm_a_left",
                    "Shoulder primary",
                ...
                [
                    ...
                    "Red to switched 5V",
                    "Brown/black to ground bus",
                    "Code sends 180 - Arm A. Flip the mirror flag if wrong.",
                ],
                [
                    "arm_b",
                    "Elbow",
                    ...
                    "Red to switched 5V",
                    "Brown/black to ground bus",
                    "Keep limits conservative while unloaded.",
                ],
                [
                    "wrist_a",
                    "Wrist pitch",
                    ...
                    "Red to switched 5V",
                    "Brown/black to ground bus",
                    "Watch for printed wrist binding.",
                ],
                [
                    "wrist_b",
                    "Wrist roll",
                ...
                [
                    ...
                    "Red to switched 5V",
                    "Brown/black to ground bus",
                    "Find open/closed values gently.",
                ],
            ],
    ...
    story.append(
        table(
            ...
            [
                [
                    "1. Bench copy",
                    "Build and calibrate the second arm exactly like Arm 1.",
                    "Every joint jogs without binding away from the conveyor.",
                ],
                [
                    "2. Fixture mock",
                    "Place a dead/static part and mark pickup/drop zones.",
                    "Manual jog can pick and place with conveyor off.",
                ],
                [
                    "3. Waypoint capture",
                    "Fill conveyor-waypoints-template.csv.",
                    "Each row has verified angles and notes.",
                ],
                [
                    "4. Slow playback",
                    "Copy angles into WAYPOINTS and unlock demo.",
                    "Cycle runs at slow speed with no part.",
                ],
                [
                    "5. Part trial",
                    "Run with part while conveyor is stopped or made safe.",
                    "Part transfers cleanly without contacting rails.",
                ],
                [
                    "6. Conveyor integration",
                    "Add read-only conveyor state/interlock inputs later.",
                    "Arm only moves when the cell is safe and expected.",
                ],
            ],
            [1.15, 2.6, 2.9],
        )
    ...
    story.append(
        table(
            ...
            [
                [
                    "Uno resets when servos move",
                    "Servo current is being pulled through USB/Uno or ground is poor.",
                    "Power servo red wires from external 5V supply; tie grounds; check supply voltage under load.",
                ],
                [
                    "Servo jitters but does not move correctly",
                    "No common ground or weak signal connection.",
                    "Tie Arduino GND to servo ground bus; reseat signal wire; keep signal wires away from noisy power wiring.",
                ],
                [
                    "Shoulder servos fight each other",
                    "Mirrored servo direction or horn position is wrong.",
                    "Cut servo power, remove load, flip SERVO_MIRRORED for that channel or re-center horns.",
                ],
                [
                    "Servo growls at an endpoint",
                    "Software limit exceeds mechanical travel.",
                    "Reduce jointMin/jointMax immediately; do not hold a stalled servo.",
                ],
                [
                    "Upload fails",
                    "D0/D1 are connected or serial monitor is open.",
                    "Keep D0/D1 unused; close Serial Monitor during upload.",
                ],
                [
                    "Gripper crushes or drops part",
                    "Open/closed angles not tuned for the object.",
                    "Record separate gripper angles for empty, grip, and release in the waypoint sheet.",
                ],
            ],
            [1.35, 2.3, 3.0],
        )
    ...
    story.append(
        table(
            ...
            [
                [
                    "docs/instructions/emre-kalem-robot-arm/wiring-map.csv",
                    "Servo-by-servo wiring table.",
                ],
                [
                    "docs/instructions/emre-kalem-robot-arm/conveyor-waypoints-template.csv",
                    "Worksheet for the second arm's load/unload poses.",
                ],
                [
                    "docs/instructions/emre-kalem-robot-arm/arduino/emre_kalem_arm_calibrate/",
                    "Calibration sketch.",
                ],
                [
                    "docs/instructions/emre-kalem-robot-arm/arduino/emre_kalem_arm_uno_controller/",
