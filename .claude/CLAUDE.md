...
- **General Intelligence Preservation** — MIRA is a general multimodal assistant first; FactoryLM evidence adds, never suppresses; answer-generation changes are benchmarked against the raw frontier model (`evals/general-intelligence/`). See `.claude/rules/general-intelligence-preservation.md`.
