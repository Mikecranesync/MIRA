> **Historical reference — superseded product priorities.** See [current north star](../../NORTH_STAR.md) and [decision history](2026-09-05-decision-history.md). Original wording is preserved below with trailing whitespace normalized; original bytes remain in Git at `32c6cfacdefbeae8ad7bf2fddc277277d77d51fe`. Historical priorities and prices are not active instructions.
