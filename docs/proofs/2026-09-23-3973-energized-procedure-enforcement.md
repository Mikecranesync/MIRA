> **Twelfth review repair (2026-09-24):** Temporal clauses could hide attach/connect test-lead instructions because those verbs were not measurement events. Three negative controls failed before repair; lead connections now receive their own ordered event and bound prohibition. Two positive controls retain explicit do-not/never instructions. Full Hub: 3,801 tests / 294 files passed. Independent exact-head review pending; #3984 remains open and no live acceptance is claimed.
