...
- [`fleet-gateway-mcp`](./fleet-gateway-mcp.md) — FactoryLM Fleet Gateway MCP: public HTTPS control plane, private/loopback CAO, nine locked tools (#3532; v1.1 legacy discover/adopt).
