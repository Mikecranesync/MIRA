...
def main():
    ...
    parser.add_argument("--host", default="192.168.1.100", help="PLC IP address (default: bench PLC)")
    parser.add_argument("--port", type=int, default=502, help="Modbus TCP port")
    parser.add_argument("--poll", type=float, default=0.5, help="Poll interval (seconds)")
    args = parser.parse_args()

    # Silence pymodbus's internal connect-retry spam ("Connection ... failed",
    # "Repeating...."). We surface a clean OFFLINE state in the dashboard instead.
