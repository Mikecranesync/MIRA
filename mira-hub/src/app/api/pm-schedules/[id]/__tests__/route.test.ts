...
// role:"owner" so the pm_schedules.write capability gate (#2360/#578) passes —
// these tests cover PM-schedule mutation behavior, not RBAC (the matrix is
// unit-tested in src/lib/__tests__/capabilities.test.ts).
const goodSession = {
  userId: "u_1",
  tenantId: TENANT_ID,
  email: "x@y",
