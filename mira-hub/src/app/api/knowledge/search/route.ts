 ...
 *
 * Full-text search across the shared OEM corpus in knowledge_entries.
 * Filters to `is_private = false` so per-tenant uploaded manuals are
 * never returned to other tenants (cross-tenant confidentiality gate).
 *
