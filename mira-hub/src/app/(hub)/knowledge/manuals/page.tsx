            ...
            <div>
                      ...
                      <div className="flex items-start justify-between gap-2">
                        <div className="min-w-0">
                          ...
                          <p className="text-[11px] mt-0.5" style={{ color: "var(--foreground-subtle)" }}>
                            {r.manufacturer}{r.modelNumber ? ` · ${r.modelNumber}` : ""}
                            {r.sourceType ? ` · ${r.sourceType}` : ""}
                          </p>
                          {r.snippet && (
                            <p className="text-[11px] mt-1.5 line-clamp-2" style={{ color: "var(--foreground-muted)" }}>
                              {r.snippet}
                            </p>
                          )}
                        </div>
                        <ChevronRight className="w-4 h-4 flex-shrink-0 mt-0.5" style={{ color: "var(--foreground-subtle)" }} />
                      </div>
                    </button>
                  ))}
                </div>
              ...
              {!contentSearching && contentResults.length === 0 && (
                <div className="text-center py-10">
                  <FileText className="w-8 h-8 mx-auto mb-3" style={{ color: "var(--foreground-subtle)" }} />
