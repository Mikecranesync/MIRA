...
## 2026-09-25 — emulator takeover checkpoint (local repair worktree)
Recovered `codex/fireplace-repair-loop` / draft #3999 after prior Codex 401. Restored local Hub and emulator staging build 13. Repaired OSD probe filter and missing visual rules on document-backed photo answers; 3921 Hub tests pass, 33 unchanged TypeScript diagnostics. Latest emulator run still fails fine-print transcription and cross-component manufacturer attribution. See `docs/proofs/fireplace-repair-20260925/EMULATOR-CHECKPOINT.md`. Private evidence remains ignored. No merge/deploy/Pixel acceptance.
