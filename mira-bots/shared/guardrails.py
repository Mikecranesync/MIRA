...
VENDOR_SUPPORT_URLS: dict[str, str] = {
    ...
    # AutomationDirect product-line aliases (CRA-12 — mirrors PowerFlex pattern)
    "gs10": "automationdirect.com/support",
    "gs20": "automationdirect.com/support",
    "gs21": "automationdirect.com/support",
    "gs23": "automationdirect.com/support",
    "durapulse": "automationdirect.com/support",
...
_VENDOR_DISPLAY_NAMES: dict[str, str] = {
    ...
    "gs23": "AutomationDirect",
    "durapulse": "AutomationDirect",
