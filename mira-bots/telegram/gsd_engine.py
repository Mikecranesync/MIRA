...
class GSDEngine:
            ...
            "content": [
                ...
                },
                {
                    ...
                    "text": (
                        ...
                        "This is a field photograph of industrial equipment or documentation — "
                        "it may be a direct photo or a photo of a screen. "
                        "If the image shows a computer monitor or laptop screen, analyze ONLY "
                        "the technical content displayed on screen (diagrams, schematics, code, data). "
                        "Ignore application toolbars, buttons, menus, window chrome, and any AI "
                        "assistant UI elements visible in the software interface. "
                        "If text is small or partially visible, describe what you can read and note "
                        "that a closer shot may be needed for full extraction. "
                        "Respond in under 100 words using plain language. "
                        "Structure your response as: "
                        "(1) What is this device or drawing — name the make, model, function, or drawing type. "
                        ...
                        "If the image is an electrical drawing, identify the drawing type and give one "
                        "actionable interpretation. Never use unexplained acronyms. Do not exceed 100 words."
                    ),
                },
            ],
        }]
    ...
    async def _call_ocr(self, photo_b64: str) -> list:
        ...
        for line in raw.strip().split("\n"):
            ...
            if not line:
                continue
            # Skip code fence markers and bare JSON syntax lines
