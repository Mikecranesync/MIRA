...
def test_phase2_merges_only_grammar_valid_confident_new_reading(monkeypatch):
    ...
    script = [
        ...
        {"regions": [{"item": "wire number near A13 LWL IN", "bbox": [100, 100, 300, 160], "found": True}]},
...
def _blind(graph_dict):
    ...
    def _bp(image_bytes):
        return PrintSynthGraph.model_validate(graph_dict), {"input_tokens": 100, "output_tokens": 50}
