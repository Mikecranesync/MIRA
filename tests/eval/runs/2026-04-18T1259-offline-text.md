...
- **cp_keyword_match** FAILED: No match from ['undervoltage', 'PowerFlex', 'voltage', 'input', 'fault', '525', 'manual', 'searching']

### vfd_mitsu_03_a700_parameter
- **cp_keyword_match** FAILED: No match from ['deceleration', 'Pr.7', 'acceleration', 'time', 'parameter', 'ramp', 'A700', 'Mitsubishi', 'VFD', 'drive', 'motor', 'fault', 'model', 'issue']

### vfd_siemens_01_sinamics_g120_f30001
- **cp_reached_state** FAILED: State='Q1', expected='DIAGNOSIS'

---
*Generated by `offline_run.py` at 2026-04-18T12:59:45.826552+00:00*
